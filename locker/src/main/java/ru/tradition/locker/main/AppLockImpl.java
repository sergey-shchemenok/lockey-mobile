package ru.tradition.locker.main;
...
import ru.tradition.locker.utils.Encryptor;
...
public class AppLockImpl extends Locker implements PageListener {
    ...
    private boolean shouldLockSceen(Activity activity) {
        ...
        Log.i("AppLockImpl", "should be locked = " + super.shouldBeLocked);
        return super.shouldBeLocked;
    }
